...
function reserveViewportForBar(){
  ...
  document.documentElement.style.setProperty('--bsr-player-reserve', `${Math.max(96, h)}px`);
}
...
function injectFooterPlayerCSS(){
  ...
  style.textContent = `
    :root{ --bsr-player-reserve: 118px; }
    html, body{ overflow-x:hidden; }
    body{ padding-bottom: calc(var(--bsr-player-reserve) + env(safe-area-inset-bottom)); }
    ...
    #audio-footer .bsr-cover-cell{grid-area:cover; align-self:stretch; display:flex; align-items:center;}
    #audio-footer .bsr-wave-cell{grid-area:wave; min-width:0;}
    #audio-footer .bsr-meta-cell{grid-area:meta; min-width:0; display:flex; flex-direction:column; gap:8px;}
    #audio-footer .bsr-time-cell{grid-area:time; justify-self:end; align-self:end;}
    #audio-footer .bsr-bt-cell{grid-area:bt; justify-self:end; align-self:start;}
    ...
    #audio-footer .bsr-meta-text{min-width:0; display:flex; flex-direction:column; gap:2px;}
    #audio-footer .cat{font-size:10px !important; opacity:.8;}
    #audio-footer .title{
    ...
    @media (min-width: 721px){
      ...
      #audio-footer .wf{height:28px !important;}
      #audio-footer .title{font-size:15px !important;}
      #audio-footer .artist{font-size:12px !important;}
      #audio-footer .btn-ctl{
...
function normalizeFooterLayout(){
  ...
  // clear everything except queue panel, then rebuild
