...
function injectFooterPlayerCSS(){
  ...
  style.textContent = `
    ...
    @media (max-width: 720px){
      ...
      #audio-footer .cat{font-size:10px !important;}
      #audio-footer .wf{
      ...
      #audio-footer .t0, #audio-footer .ttot{font-size:11px !important;}
    }
  `;
