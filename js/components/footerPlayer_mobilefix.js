...
function injectFooterPlayerCSS(){
  ...
  style.textContent = `
    #audio-footer{position:relative !important;overflow:visible !important;}
    #audio-footer .queue-panel{z-index:2147483647 !important;}
    #audio-footer .bt-ind{display:flex;align-items:center;gap:6px;white-space:nowrap;}
    #audio-footer .btn-ctl.queue{display:inline-flex;align-items:center;justify-content:center;}
    @media (max-width: 720px){
      #audio-footer{padding-bottom:max(8px, env(safe-area-inset-bottom));}
      #audio-footer .queue-panel{right:8px !important;left:8px !important;width:auto !important;bottom:72px !important;max-height:46vh !important;}
      #audio-footer .meta,
      #audio-footer .track-meta,
      #audio-footer .info,
      #audio-footer .player-meta{min-width:0;}
      #audio-footer .title{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;line-height:1.1;}
      #audio-footer .artist{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
      #audio-footer .wf{min-width:0 !important;width:100% !important;max-width:none !important;}
      #audio-footer .right,
      #audio-footer .controls,
      #audio-footer .actions,
      #audio-footer .transport{flex-wrap:wrap;align-items:center;row-gap:8px;}
      #audio-footer .bt-ind{font-size:10px !important;opacity:.75 !important;}
    }
  `;
