...
export const releases = [  
  ...
  {  
    ...
    oggAudio: "/audio/BSR002_st.ogg",
    mp3Audio: "/audio/BSR002_st.mp3",
  ...
  credits: {
   ...
   {  
    ...
    descriptionShort:
      "Late-night soulful house. Music that stays a little longer.",  
    descriptionLong:
  ...
  embeds: {
    youtube: "Y-JA9TfIg9Y",
    spotify: "track:4mL4bLtEl99oTJWdbtXqGK"
  },
    links: { 
      stream: { 
