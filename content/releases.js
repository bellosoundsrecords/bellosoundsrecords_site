...
export const releases = [  
  {  
    ...
    artists: ["Nick Evan"],  
    alias: "nick-evan",  
    previewAudio: "/audio/previews/BSR001_mono64.mp3",  
  ...
  {  
    ...
    artists: ["Nick Evan"],  
    alias: "nick-evan",  
    previewAudio: "/audio/previews/BSR002_mono64.mp3",  
  ...
  {  
    ...
    artists: ["Neel Miles"],  
    alias: "neel-miles",  
    previewAudio: "/audio/previews/BSR003_mono64.mp3",  
    ...
    links: { 
      stream: { 
        youtube: "https://www.youtube.com/watch?v=2kkpkOQRlao" 
      } 
    },  
    credits: {  
  ...
  {  
    ...
    artists: ["Nick Evan"],  
    alias: "nick-evan",  
    previewAudio: "/audio/previews/BSR004_mono64.mp3",  
  ...
  {  
    ...
    descriptionShort:
      "A raw, instinctive groove with a 70’s soul and a Chicago heartbeat. Stream the full track here before the official release. More soon… stay tuned and feel it.",  
    descriptionLong:
      "A groove born between Chicago’s roots and Pilsen’s lights. “Feel It” blends 70’s drum textures, soulful tension and an instinctive vocal line designed to move the floor. Neel Miles delivers his most physical track to date — direct, warm, alive.",  
    tracks: [  
